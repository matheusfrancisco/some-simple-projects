class DropBoxController{
    ...
    constructor(){
        this.currentFolder = ['pastas'];

        this.onSelectionOnChange = new Event('selectionchange');
    ...
    connectFirebase(){
        ...
        // Initialize Firebase
        var config = {
            apiKey: "AIzaSyAatWo0A3SmNR-YuAJwu8ldYR0Lt5rDV-I",
        authDomain: "dropbox-clone-course-test.firebaseapp.com",
        databaseURL: "https://dropbox-clone-course-test.firebaseio.com",
        projectId: "dropbox-clone-course-test",
        storageBucket: "dropbox-clone-course-test.appspot.com",
        messagingSenderId: "713551594713"
        };
    ...
    initEvents(){
        ...
        this.inputFileElement.addEventListener('change', event=>{
            ...
            this.btnSendFileElement.disabled = true;
    ...
    uploadComplete(){
        ...
        this.btnSendFileElement.disabled = false;
    ...
    ajax(url, method = 'GET' , formData = new FormData(),onprogess =function(){},onloadstart =function(){}){
        return  new Promise((resolve, reject)=>{
            ...
            ajax.upload.onprogress = onprogess;
        ...
        li.addEventListener('click', e=>{
            ...
            if(e.shiftKey){
                ...
                if(firstLi){
                    ...
                    this.listFilesEl.dispatchEvent(this.onSelectionOnChange);
